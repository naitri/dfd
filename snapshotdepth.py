...
class SnapshotDepth(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--focal_depth', type=float, default=2.5)
        parser.add_argument('--f_number', type=float, default=1.4)
        ...
        parser.add_argument('--bayer', dest='bayer', action='store_false')
